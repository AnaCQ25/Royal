        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="card-title">
              <div class="row">
                <div class="col">
              <center><h3 class="mr-2" style="color: #53125b;"><span><b>Calificaciones</b></span><small class="px-1"></small></h3></center>
                </div>
              </div>
              <div class="row">
                <div class="col">
            ...
            <div class="e-table">
              <div class="table-responsive table-xl mt-3">
                <table class="table table-bordered">
                  <thead>
                    <tr>
                      ...
                      <th class="max-width">Calificación 1ra Asignatura</th>
                      <th class="max-width">Calificación 2da Asignatura</th>
                  ...
                  <tbody>
                    ...
                    require 'database.php';
                     ...
                     $records2 = $conn->prepare('SELECT id, foto, estado, nombre, apellido, matricula, carrera, 1ra_asignatura, 2da_asignatura, calificacion_1ra_asignatura, calificacion_2da_asignatura, password_estudiante FROM estudiante');
                     $records2->execute();
                ...
                echo "<img src='images/".$results2['foto']."'  class='image' id='imagenPrevisualizacion' width=60px height=60px>";
                      ...
                      <td class="text-nowrap align-middle"><span><?php echo $results2['calificacion_1ra_asignatura'];?></span></td>
                      <td class="text-nowrap align-middle"><span><?php echo $results2['calificacion_2da_asignatura'];?></span></td>
                      <td class="text-center align-middle">
                        <div class="btn-group align-top">
                            <a href="#editar_<?php echo $results2['id']; ?>" class="btn btn-default btn-sm" style="color: white; background-color: #53125b" data-toggle="modal"><span class="glyphicon glyphicon-edit"></span> Editar </a>
                        </div>
                      </td>
                      <?php include('editar_eliminar_calificacion.php'); ?>
                    </tr>
                    ...
                    <div class="row">
                      <div class="col">
                        <div class="form-group">
                          ...
                          <input class="form-control" name="password_estudiante" type="password" placeholder="Ingrese la contraseña">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col">
                        <div class="form-group">
                          ...
                          <input class="form-control" type="password" placeholder="Confirme la contraseña"></div>
                      </div>
                    </div>
                  </div>
