    ...
    <?php
        if(isset($_POST['recuperar'])){
            ...
            $email = $_POST['email'];
             ...
             $records3 = $conn->prepare('SELECT nombre, email FROM estudiante WHERE email = :email');
             ...
             if(count($results3) > 0){
                ...
                $sql4 = "UPDATE `estudiante` SET token = '$token' WHERE `email` = :email";
                ...
                http://localhost/Royal/nuevacontra_estudiante.php?email=".$results3['email']."&token=".$token."\n\n";
      ...
      <label>
        ...
        <div>
                      ...
                      <button type="submit" class="submit" name="recuperar">Enviar</button>  
                         ...
                         <button style="color: white; background-color: #a79b31;" class="submit" id="cancelar" name="cancelar" onclick="self.location.href = 'login2.php'" onkeypress="self.location.href = 'login2.php'"> Volver </button>
