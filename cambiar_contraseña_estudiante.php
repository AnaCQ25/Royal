...
$records2 = $conn->prepare('SELECT `id`, `password_estudiante` FROM `estudiante` WHERE `id` = :id');
    $records2->bindParam(':id', $_SESSION['user_id2']);
    $records2->execute();
...
if(password_verify($_POST['password_actual'], $results2['password_estudiante'])){

  if ($password == $confirm_password){
          $sql1 = "UPDATE `estudiante` SET `password_estudiante` = :password_estudiante WHERE `id` = :id";
 ...
 windows.location='cambiar_contraseña_estudiante.php';</script>";
            header('Location: /Royal/cambiar_contraseña_estudiante.php');
            }
        }else{
                 echo "<script> alert('Error al cambiar los datos'); windows.location='cambiar_contraseña_estudiante.php';</script>";
            }
...
<div class="col-md-12 mt-lg-4 mt-4">
   ...
   <div class="main">
    <form action="cambiar_contraseña_estudiante.php" role="form" method="post">
    <div class="container">
          ...
          <div class="input-group">
            ...
            <input ID="password_estudiante" type="Password" class="form-control" onkeyup="validatePassword(this.value);" name="password_estudiante"  placeholder="Ingresa tu nueva contraseña">
          <div class="input-group-append">
